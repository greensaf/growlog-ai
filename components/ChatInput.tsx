...
export function ChatInput({
  ...
  return (
  <form onSubmit={handleSend} className="flex items-center gap-2 px-4 sm:px-6 md:px-8 lg:px-12 py-3 w-full pb-[calc(env(safe-area-inset-bottom)+8px)] bg-background">
      <Input
